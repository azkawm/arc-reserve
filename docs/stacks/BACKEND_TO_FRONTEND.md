...
| 2026-08-30 | **CHANGED** — `/candles` is **not** implemented (Milestone D); the route 404s rather than returning empty candles. | Keep the chart on fixtures with a Mock badge until D ships. |
